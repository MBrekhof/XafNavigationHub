...
namespace XafNavigationHub.Module
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed class XafNavigationHubModule : ModuleBase
    {
        public XafNavigationHubModule()
        {
            //
            // XafNavigationHubModule
            //
            AdditionalExportedTypes.Add(typeof(XafNavigationHub.Module.BusinessObjects.ApplicationUser));
